...
class whatever {
	...
	public void setup() {
		//Resource.Factory.Registry.INSTANCE.getExtensionToFactoryMap().put("*", new TResourceFactoryImpl());
	...
	@Test
	void testMetaModelIsUpToDate() throws Exception {
	...
	@Test
	void testModelTest_testGetContents_NotContainsOldElement() throws Exception {
	...
	@Test
	void testModelTest_testGetContentsAt_ContainsOldElement() throws Exception {
	...
	@Test
	void testModelTest_testGetContentsAt_NotContainsCurrentElement() throws Exception {
	...
	@Test
	void testModelTest_testGetNameAt() throws Exception {
